...
export const STUDY_ASSISTANT_SYSTEM = `You are an expert educator who combines the knowledge depth of a professor with the personalized attention of a private tutor.
...
export const LECTURE_SUMMARY_PROMPT = `Summarize the following lecture content for effective studying.
...
export const FLASHCARD_GENERATOR_PROMPT = `Generate study flashcards from the following content.
...
export const QUIZ_GENERATOR_PROMPT = `Generate a quiz from the following study material.
...
export const CONCEPT_EXPLAINER_PROMPT = `Explain the following concept to a student.
...
export const CODE_DEBUGGER_PROMPT = `Debug and explain the following code issue.
