...
exports.SECTION_GENERATOR_PROMPT = exports.BULLET_IMPROVEMENT_PROMPT = exports.RESUME_QUICK_SCORE_PROMPT = exports.RESUME_ANALYSIS_SIMPLE_PROMPT = exports.RESUME_ANALYSIS_PROMPT = exports.RESUME_ANALYZER_SYSTEM = void 0;
// ============================================
// SYSTEM INSTRUCTIONS
// ============================================
exports.RESUME_ANALYZER_SYSTEM = `You are an expert Resume Analyzer with three distinct capabilities:
...
// ============================================
exports.RESUME_ANALYSIS_PROMPT = `Analyze the following resume for the target role: **{{targetRole}}**
...
// ============================================
exports.RESUME_ANALYSIS_SIMPLE_PROMPT = `Analyze the following resume for the target role: **{{targetRole}}**
...
// ============================================
exports.RESUME_QUICK_SCORE_PROMPT = `Quickly evaluate this resume for {{targetRole}}:
...
// ============================================
exports.BULLET_IMPROVEMENT_PROMPT = `Improve this resume bullet point for a {{targetRole}} role:
...
// ============================================
exports.SECTION_GENERATOR_PROMPT = `Generate a {{sectionName}} section for a {{targetRole}} resume.
...
//# sourceMappingURL=resume.prompts.js.map